#8)WAP to print the sum of even index positions of all the even numbers present in the given string
s=input() # take the string output from the user(0123456)
...
while ip<len(s): # while loop starts with the ip less than the length of the string
    if s[ip] in '02468': #   if loop starts with the condition of checking the number includes in even numbers
        summ+=ip # add to the sum if the even ip has even numbers 
